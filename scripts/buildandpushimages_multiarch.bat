...
echo "building and pushing image spring-boot-2-hello-world-buildstage"
pushd source
docker buildx build --platform ${PLATFORMS} -f Dockerfile.buildstage --push --tag ${REGISTRY_URL}/${REGISTRY_NAMESPACE}/spring-boot-2-hello-world-buildstage .
popd

echo "building and pushing image spring-boot-2-hello-world"
pushd source
docker buildx build --platform ${PLATFORMS} -f Dockerfile --push --tag ${REGISTRY_URL}/${REGISTRY_NAMESPACE}/spring-boot-2-hello-world .
popd
