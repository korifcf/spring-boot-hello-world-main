...
echo "building image spring-boot-2-hello-world-buildstage"
pushd source
%CONTAINER_RUNTIME% build -f Dockerfile.buildstage -t spring-boot-2-hello-world-buildstage .
popd

echo "building image spring-boot-2-hello-world"
pushd source
%CONTAINER_RUNTIME% build -f Dockerfile -t spring-boot-2-hello-world .
popd
