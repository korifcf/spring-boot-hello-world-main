...
:DEFAULT_REGISTRY
    SET REGISTRY_URL=index.docker.io
    SET REGISTRY_NAMESPACE=korificf
	GOTO DOCKER_CONTAINER_RUNTIME
...
echo "pushing image spring-boot-2-hello-world"
%CONTAINER_RUNTIME% tag spring-boot-2-hello-world %REGISTRY_URL%/%REGISTRY_NAMESPACE%/spring-boot-2-hello-world
%CONTAINER_RUNTIME% push %REGISTRY_URL%/%REGISTRY_NAMESPACE%/spring-boot-2-hello-world

echo "pushing image spring-boot-2-hello-world-buildstage"
%CONTAINER_RUNTIME% tag spring-boot-2-hello-world-buildstage %REGISTRY_URL%/%REGISTRY_NAMESPACE%/spring-boot-2-hello-world-buildstage
%CONTAINER_RUNTIME% push %REGISTRY_URL%/%REGISTRY_NAMESPACE%/spring-boot-2-hello-world-buildstage
